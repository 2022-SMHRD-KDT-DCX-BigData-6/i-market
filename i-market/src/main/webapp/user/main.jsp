	...
	<div id="wrapper">
		...
		<ul class="actions vertical">
			...
			<form action="Join" method="post">
				...
				<li><input type="text" name="user_nick" placeholder="닉네임를 입력하세요"></li>
		...
		<div class="inner">
			...
			<!-- 로그인 후 로그인 한 사용자의 세션아이디로 바꾸시오.ex)smart님 환영합니다 --> </header>
				<h1><%=loginMember.getUser_nick() %>님 환영합니다.</h1>
				<%} %>
			<div class="content">
				<p>
		...
		<div class="inner">
			...
			<div class="contact-method">
				...
				<%} else { %>
				<a href="#"><%=loginMember.getUser_id() %></a>
				<%} %>
			</div>
			</section> <section>
			<div class="contact-method">
				...
				<%} else { %>
				<a href="#"><%=loginMember.getUser_phone() %></a>
				<%} %>
			</div>
			</section> <section>
			<div class="contact-method">
				...
				<%} else { %>
				<a href="#"><%=loginMember.getUser_addr() %></a>
				<%} %>
			</div>
			</section> </section>
		</div>
